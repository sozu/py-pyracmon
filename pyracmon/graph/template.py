...
class GraphTemplate:
    ...
    class Property:
        ...
        def _move_template(self, dest: 'GraphTemplate', new_name=None) -> Self:
            """
        ...
        @overload
        def __lshift__(self, children: Self) -> Self: ...
        @overload
        def __lshift__(self, children: list[Self]) -> list[Self]: ...
        def __lshift__(self, children: Union[Self, list[Self]]) -> Union[Self, list[Self]]:
            """
        ...
        def __rshift__(self, parent: Self) -> Self:
            """
        ...
        def __rrshift__(self, children: Union[Self, list[Self]]) -> Self:
            """
